...
<header>
    ...
    <nav role="main">
      <ul>
        ...
        <li><a class="link1" href="accueil.php?idclient=<?php echo $value ;?>">Home</a></li>
        <li><a class="link1" href="homeuser.php?idclient=<?php echo $value ;?>">utilisateur</a></li>
		<li><a class="link1" href="login1[1].php">admin</a></li>
      </ul>
    </nav>
  </header>
  <style>
...
<body>
    ...
    <form method="GET" action="prodetails.php"><table>  
      ...
      if (!$conn) {
        ...
        '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.'
		<style>.link3{outline: none;
			text-decoration: none;margin:9px;color:#FFFCEB;}.bye {border-radius: 100px;font-size:40px;
            ...
            <span class="bye"><a class="link3" href="prodetails.php?orderID='.$row['num_pro'].'& idclient='.$value.'">
			 + </a></span></td>';$i++;}
			else{$i = 4;$j = 1001;}}
				echo'</tr>';
				$j++;}
